...
public class health_care extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databasefin =FirebaseDatabase.getInstance().getReference("HealthCareQB_Answers");
        ...
        if(!TextUtils.isEmpty(Answer1)){
            ...
            HealthCareQB_Answers fin=new HealthCareQB_Answers(id,rid,Answer1,Answer2,Answer3,Answer4,Answer5);

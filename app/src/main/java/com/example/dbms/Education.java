...
public class Education extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databasefin =FirebaseDatabase.getInstance().getReference("EducationQB_Answers");
        ...
        if(!TextUtils.isEmpty(Answer1)){
            ...
            EducationQB_Answers fin=new EducationQB_Answers(id,rid,Answer1,Answer2,Answer3,Answer4,Answer5);

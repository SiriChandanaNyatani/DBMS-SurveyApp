...
public class agriculture extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databasefin =FirebaseDatabase.getInstance().getReference("AgricultureQB_Answers");
        ...
        if(!TextUtils.isEmpty(Answer1)){
            ...
            AgricultureQB_Answers fin=new AgricultureQB_Answers(id,rid,Answer1,Answer2,Answer3,Answer4,Answer5);
    ...
    {
        Intent intent = new Intent(agriculture.this, QBSelect.class);
